        ...
        <div className={styles.container}>
            <div className={styles.card}>
                <div className={styles.header}>
                    <h1>Welcome Back</h1>
                    <p>Sign in to your catering dashboard</p>
                </div>
                ...
                <div className="space-y-4 w-full">
                    ...
                    <div className="relative">
                        ...
                        >
                            {devMode ? '🔓 Dev Mode Active' : '🔒 Click for Dev Mode'}
                        </button>

                        {devMode && (
                            <div className="absolute w-full mt-2 p-4 bg-amber-500/10 border border-amber-500/30 rounded-xl backdrop-blur-sm">
                                <p className="text-xs text-amber-400 mb-3">⚠️ Development Mode - Bypass Authentication</p>
                                <button
                                    onClick={handleDevLogin}
                                    disabled={loading}
                                    className="w-full bg-amber-500 text-slate-900 font-semibold py-2 px-4 rounded-lg hover:bg-amber-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {loading ? 'Logging in...' : 'Enter as Admin (Dev)'}
                                </button>
                            </div>
                        )}
                    </div>
